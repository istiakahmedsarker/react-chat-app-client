...
const Dashboard = () => {
    ...
    return (
        <div className="w-full flex bg-white dark:bg-primary-dark overflow-x-hidden">
            ...
            <div className="w-[22%] border-2 border-white h-screen dark:bg-[#242526] overflow-y-scroll">
            ...
            <div className="w-[58%] border-2 border-white flex flex-col items-center bg-white h-screen">
                ...
                <div className="  w-full dark:bg-[#242526]  overflow-y-scroll shadow-sm ">
            ...
            <div className="w-[20%] border-2 border-white  h-screen  overflow-y-scroll">
